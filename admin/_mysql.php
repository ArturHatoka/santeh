...
$m_Link = mysql_connect("p376856.mysql.ihc.ru", "p376856_222ktc", "gh5dtnbr") or die ("<!-- Ошибка подключения к серверу. -->");
mysql_query("SET NAMES utf8");
mysql_select_db("p376856_222ktc") or die ("<!-- Ошибка соединения с БД. -->");
